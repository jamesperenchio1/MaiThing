export default {
  ...
  auth: {
    ...
    onboarding: {
      ...
      step: 'Step {{step}}',
      howItWorks: {
        browse: { title: 'Browse nearby', desc: 'Find surprise bags and fixed deals from cafes, bakeries, and restaurants around you.' },
        reserve: { title: 'Reserve in app', desc: 'Pay securely and get a pickup code. Beat the rush — quantities are limited.' },
        pickup: { title: 'Pick up & enjoy', desc: 'Show your code during the pickup window and rescue delicious food at a great price.' },
      },
      trust: {
