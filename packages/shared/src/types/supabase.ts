...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      chat_threads: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "chat_threads_location_id_fkey"
            columns: ["location_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "chat_threads_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
      ...
      demand_signals: {
        ...
        Relationships: [
          {
            foreignKeyName: "demand_signals_buyer_id_fkey"
            columns: ["buyer_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
        ...
        Relationships: [
          {
            ...
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "merchant_orgs"
            referencedColumns: ["id"]
          },
        ]
      }
      merchant_orgs: {
        ...
        Relationships: [
          {
            foreignKeyName: "merchant_orgs_owner_id_fkey"
            columns: ["owner_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      slot_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "slot_templates_location_id_fkey"
            columns: ["location_id"]
            isOneToOne: false
            referencedRelation: "locations"
            referencedColumns: ["id"]
      ...
      user_impact: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_impact_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: true
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      reserve_order: {
        Args: { p_items?: Json; p_listing_id: string; p_slot_id: string }
        Returns: {
          order_id: string
          pickup_code: string
          qr_payload: string
    ...
    Enums: {
      ...
      issue_status: "open" | "auto_refunded" | "resolved" | "rejected"
      listing_status: "draft" | "active" | "sold_out" | "expired" | "cancelled"
      location_status: "pending" | "active" | "paused"
      order_status:
        | "reserved"
        | "paid"
        | "collected"
      ...
      user_role: "buyer" | "merchant" | "admin"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
