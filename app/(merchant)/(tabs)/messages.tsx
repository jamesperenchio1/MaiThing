...
export default function MerchantMessagesTabScreen() {
  ...
  return (
    <Screen testID="merchant-messages-tab-screen" scrollable className="bg-background">
      {/* Tab-level header — no back button */}
      <View className="px-6 pt-4 pb-2">
        <Text variant="h2">{t('merchant.messages.title')}</Text>
      </View>
